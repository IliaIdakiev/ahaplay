...
//   return redisClient
//     .get(sessionProcessorName)
//     .then((sessionProcessorStatus) => {
//       const connected = new Promise<string>((res) => {
//         let resolved = false;
//         pubSub.subscribe(
...
//             ) {
//               redisClient.set(
//                 sessionProcessorName,
//                 SessionProcessorStatus.STARTED
//               );
//               resolved = true;
//               res(sessionProcessorName);
//             }
//           }
//         );
//       });

//       if (sessionProcessorStatus) {
//         if (sessionProcessorStatus === SessionProcessorStatus.STARTED)
//           return Promise.resolve(sessionProcessorName);
//         return connected;
//       }
//       redisClient.set(sessionProcessorName, SessionProcessorStatus.STARTING);
...
//       function cleanup() {
//         redisClient.set(sessionProcessorName, SessionProcessorStatus.STOPPED);
//         console.log("Clean up...");
//       }

//       function childProcessCleanup() {
//         redisClient.set(sessionProcessorName, SessionProcessorStatus.FINISHED);
