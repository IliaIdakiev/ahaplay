...
const csvFilePath = path.resolve(__dirname, "..", "db_exports", "prod", "questions");
const databaseTableName = "questions";
...
module.exports = {
  async up(queryInterface, Sequelize) {
    ...
    const data = lines.map(line => {
      ...
      return {
        text: lineItems[0],
        activity_id: lineItems[1],
        g_duration: lineItems[2],
        i_duration: lineItems[3],
        assignment_id: lineItems[4],
        theory_id: lineItems[5],
      }
    });
